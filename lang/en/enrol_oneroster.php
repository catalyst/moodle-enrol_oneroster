...
$string['missingfiles'] = 'The following required files are missing: {$a->files}';
$string['invalidheaders'] = 'The following files have invalid or missing headers: {$a->headers}';
$string['invalid_manifest_selection'] = '{$a->manifest} is not needed. Update its value to "absent" in the manifest file';
...
$string['synchronise_failure'] = 'Failed to synchronise data, please check your CSV files against the <a href="https://www.imsglobal.org/oneroster-v11-final-csv-tables" target="_blank">OneRoster v1p1 Specification</a>.';
