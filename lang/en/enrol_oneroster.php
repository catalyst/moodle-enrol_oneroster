...
$string['missingfiles'] = 'The following required files are missing: {$a}';
$string['invalidheaders'] = 'The following files have invalid or missing headers: {$a}';
$string['invalid_manifest_selection']= '{$a} is not needed. Update its value to "absent" in the manifest file';
