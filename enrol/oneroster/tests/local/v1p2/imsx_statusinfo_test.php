...
// Explicit requires to avoid namespace autoload issues
require_once(__DIR__ . '/../../../../local/v1p2/codeMajor.php');
require_once(__DIR__ . '/../../../../local/v1p2/severity.php');
require_once(__DIR__ . '/../../../../local/v1p2/minorFieldValue.php');
require_once(__DIR__ . '/../../../../local/v1p2/codeMinor.php');
require_once(__DIR__ . '/../../../../local/v1p2/imsx_statusinfo.php');
