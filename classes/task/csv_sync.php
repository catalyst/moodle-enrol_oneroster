 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class csv_sync extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('csvsync', 'enrol_oneroster');
    }

    /**
     * Run task for processing CSVs.
     */
    public function execute() {
        ...
        $client->authenticate();
        #run csv processing 
        exec('php enrol/oneroster/process_csv.php');
        #sync client data
        $client->synchronise();
    }
}
